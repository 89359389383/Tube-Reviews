...
Rails.application.configure do
  ...
  # This line configures Rails to handle exceptions using the routes and views.
  ...
  # Disable caching in production (for debugging purposes)
  ...
  config.hosts << "tube-reviews-1.onrender.com"

  # Ensure custom assets are precompiled
